CitiFix is a simple full-stack web app that lets citizens report local public issues like potholes, streetlight outages, or water leaks. Designed for transparency and faster civic response.
